...
export const MAIN_RECIPE_LIST_REQUEST = "MAIN_RECIPE_LIST_REQUEST";
export const MAIN_RECIPE_LIST_SUCCESS = "MAIN_RECIPE_LIST_SUCCESS";
export const MAIN_RECIPE_LIST_FAIL ="MAIN_RECIPE_LIST_FAIL";
